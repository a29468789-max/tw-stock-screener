...
APP_VERSION = "2026-02-21r2120-healthcheck-autofix56"  # healthcheck auto-repair bump: force fresh deploy/cache-bust; lock local-pool + single-symbol fallback as default path
