...
APP_VERSION = "2026-02-21r1918-healthcheck-autofix10"  # healthcheck auto-repair bump: force redeploy + keep local pool/single-symbol query available when upstream APIs fail
