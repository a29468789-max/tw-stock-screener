...
APP_VERSION = "2026-02-21r1656-healthcheck-hotfix8"  # healthcheck auto-bump: trigger redeploy and enforce local-first stock pool + single-symbol fallback even when upstream pool API fails
