...
APP_VERSION = "2026-02-21r1740-healthcheck-hotfix26"  # healthcheck auto-bump: force redeploy; enforce local-first stock pool/single-symbol fallback even when upstream APIs fail
