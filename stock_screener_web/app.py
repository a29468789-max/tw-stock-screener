...
APP_VERSION = "2026-02-21r2126-healthcheck-autofix60"  # healthcheck auto-repair bump: force fresh deploy/cache-bust; enforce local-pool + single-symbol fallback path when upstream APIs wobble
