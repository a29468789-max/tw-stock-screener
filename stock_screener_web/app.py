...
APP_VERSION = "2026-02-21r2112-healthcheck-autofix52"  # healthcheck auto-repair bump: force fresh deploy/cache-bust; lock local-pool + single-symbol fallback as default path
