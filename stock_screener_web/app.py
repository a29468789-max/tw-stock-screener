...
APP_VERSION = "2026-02-21r2106-healthcheck-autofix50"  # healthcheck auto-repair bump: force fresh deploy/cache-bust; keep local-pool + single-symbol fallback as default path
