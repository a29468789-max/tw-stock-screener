...
APP_VERSION = "2026-02-21r1706-healthcheck-hotfix12"  # healthcheck auto-bump: force redeploy; keep local-first stock pool and single-symbol fallback even when upstream APIs fail
