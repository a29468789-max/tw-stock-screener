...
APP_VERSION = "2026-02-21r2153-healthcheck-autofix70"  # healthcheck auto-repair bump: trigger Render autoDeploy/cache-bust so stale pool-error instances are replaced by local-first fallback flow
