...
APP_VERSION = "2026-02-21r2144-healthcheck-autofix67"  # healthcheck auto-repair bump: trigger Render autoDeploy/cache-bust so stale pool-error instances are replaced by local-first fallback flow
