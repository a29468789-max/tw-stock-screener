...
APP_VERSION = "2026-02-21r1754-healthcheck-hotfix33"  # healthcheck auto-bump: force redeploy; local-first stock pool + single-symbol query stay available even if upstream APIs fail
