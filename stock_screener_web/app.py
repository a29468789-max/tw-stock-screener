...
APP_VERSION = "2026-02-21r1719-healthcheck-hotfix18"  # healthcheck auto-bump: force redeploy; ensure local-first stock pool/single-symbol fallback stays active even when upstream APIs fail
