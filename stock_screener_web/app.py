...
APP_VERSION = "2026-02-21r2140-healthcheck-autofix65"  # healthcheck auto-repair bump: force fresh deploy/cache-bust so local-pool fallback replaces stale pool-error page
