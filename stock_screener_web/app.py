...
APP_VERSION = "2026-02-21r1740-healthcheck-hotfix25"  # healthcheck auto-bump: force redeploy; keep local-first stock pool/single-symbol fallback active when upstream APIs fail
