...
APP_VERSION = "2026-02-21r2010-healthcheck-autofix32"  # healthcheck auto-repair bump: force fresh deploy/cache-bust; keep local-pool + single-symbol fallback as default path
