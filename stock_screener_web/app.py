...
APP_VERSION = "2026-02-21r1717-healthcheck-hotfix17"  # healthcheck auto-bump: force redeploy; ensure local-first stock pool/single-symbol fallback stays active even when upstream APIs fail
