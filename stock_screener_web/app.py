...
APP_VERSION = "2026-02-21r2115-healthcheck-autofix55"  # healthcheck auto-repair bump: force fresh deploy/cache-bust; lock local-pool + single-symbol fallback as default path
