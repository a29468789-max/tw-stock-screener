...
APP_VERSION = "2026-02-21r1949-healthcheck-autofix21"  # healthcheck auto-repair bump: force redeploy/cache-bust + keep local-pool + single-symbol fallback active during upstream pool outages
