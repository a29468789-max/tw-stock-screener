...
APP_VERSION = "2026-02-21r1926-healthcheck-autofix14"  # healthcheck auto-repair bump: force redeploy/cache-bust + guarantee local-pool single-symbol query fallback when upstream APIs fail
