...
APP_VERSION = "2026-02-21r1735-healthcheck-hotfix23"  # healthcheck auto-bump: force redeploy; keep local-first stock pool/single-symbol fallback active when upstream APIs fail
