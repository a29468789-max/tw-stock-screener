...
APP_VERSION = "2026-02-21r1712-healthcheck-hotfix15"  # healthcheck auto-bump: force redeploy; enforce local-first stock pool + emergency fallback to prevent empty universe when upstream APIs fail
