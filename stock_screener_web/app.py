...
APP_VERSION = "2026-02-21r2141-healthcheck-autofix66"  # healthcheck auto-repair bump: trigger Render autoDeploy/cache-bust so stale pool-error instances are replaced by local-first fallback flow
