...
APP_VERSION = "2026-02-21r1743-healthcheck-hotfix27"  # healthcheck auto-bump: force redeploy; enforce local-first stock pool/single-symbol fallback even when upstream APIs fail
