...
APP_VERSION = "2026-02-21r1901-healthcheck-autofix"  # healthcheck auto-repair bump: force redeploy + keep local-pool-first fallback + manual single-symbol query fallback
