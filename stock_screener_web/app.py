...
APP_VERSION = "2026-02-21r1730-healthcheck-hotfix22"  # healthcheck auto-bump: force redeploy; enforce local-first stock pool/single-symbol fallback when upstream APIs fail
