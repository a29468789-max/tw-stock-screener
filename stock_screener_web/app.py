...
APP_VERSION = "2026-02-21r1935-healthcheck-autofix17"  # healthcheck auto-repair bump: force redeploy/cache-bust + enforce local-pool + single-symbol fallback path during upstream pool outages
