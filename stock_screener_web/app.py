...
APP_VERSION = "2026-02-21r1725-healthcheck-hotfix20"  # healthcheck auto-bump: force redeploy; keep local-first stock pool/single-symbol fallback active when upstream APIs fail
