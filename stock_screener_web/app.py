...
APP_VERSION = "2026-02-21r1705-healthcheck-hotfix11"  # healthcheck auto-bump: force redeploy; keep local-first stock pool and single-symbol fallback even when upstream APIs fail
