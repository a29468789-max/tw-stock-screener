...
APP_VERSION = "2026-02-21r1930-healthcheck-autofix15"  # healthcheck auto-repair bump: force redeploy/cache-bust + keep local-pool + single-symbol fallback alive even when upstream APIs fail
