...
APP_VERSION = "2026-02-21r2025-healthcheck-autofix39"  # healthcheck auto-repair bump: force fresh deploy/cache-bust; keep local-pool + single-symbol fallback as default path
